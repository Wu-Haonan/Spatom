...
class Spatom(nn.Module):
    ...
    changed from https://github.com/chennnM/GCNII
    '''
    def __init__(self, nlayers=LAYER, nfeat=67, nhidden=HIDDEN, dropout=DROPOUT, lamda=LAMBDA, alpha=ALPHA,out_dim =1):
        ...
        self.GAT2 = GATLayer(nhidden, nhidden, dropout, 0.2)
        self.GAT3 = GATLayer(nhidden, nhidden, dropout, 0.2)
        self.GAT4 = GATLayer(nhidden, nhidden, dropout, 0.2)
        self.fc = nn.Linear(nfeat, nhidden)
        self.classification1 = nn.Linear(nhidden,128)
        self.classification2 = nn.Linear(128, 64)
